      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="text-center mb-4 md:mb-8">
            <h1 className="text-xl md:text-4xl font-bold text-white mb-4">Premium Car Collection</h1>
          ...
          {/* Search and Controls */}
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between bg-gray-900 rounded-2xl p-4 md:p-6 border border-gray-800">
